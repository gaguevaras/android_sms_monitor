...
public class MainActivity extends AppCompatActivity
    ...
    static final int REQUEST_RECEIVE_SMS = 1004;
    ...
    private void requestReceiveSms() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(mDrawerLayout, R.string.permission_receive_sms_rationale,
...
//            Intent intent = new Intent(this, SpreadsheetMainActivity.class);
